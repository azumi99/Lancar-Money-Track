...
import { GetKategori, DeleteKategori, handleAddHarcodeKategori } from "@screens/profile/detailPengaturan/pengaturanKategori/modelKategori";
        ...
        <>
            <DraggableFlatList
                ...
                renderItem={({ item, drag, isActive }: RenderItemParams<typeof kategori[0]>) => (
                    <ScaleDecorator>
                        <TouchableOpacity onLongPress={drag} disabled={isActive} onPress={() => navigation.navigate("StackNav", { screen: "AddKategori", params: { parameter: 'pengeluaran', data: kategori.find((cat) => cat.key === item.key) }, })}>
            ...
            <Fab
                ...
                bgColor="$yellow500"
                onPress={() => navigation.navigate("StackNav", { screen: "AddKategori", params: { parameter: "pengeluaran" } })}
            >
                <FabIcon as={AddIcon} />
            </Fab>
